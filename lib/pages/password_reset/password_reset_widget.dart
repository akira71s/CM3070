  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> passwordResetUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final passwordResetUsersRecord = passwordResetUsersRecordList.isNotEmpty
            ? passwordResetUsersRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: (passwordResetUsersRecord
                                                    ?.email ==
                                                null ||
                                            passwordResetUsersRecord?.email ==
                                                '')
                                        ? null
                                        : () async {
