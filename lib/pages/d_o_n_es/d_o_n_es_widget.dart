...
import 'd_o_n_es_model.dart';
export 'd_o_n_es_model.dart';

class DONEsWidget extends StatefulWidget {
  const DONEsWidget({
    super.key,
    bool? isTodo,
  }) : this.isTodo = isTodo ?? false;

  final bool isTodo;

  @override
  State<DONEsWidget> createState() => _DONEsWidgetState();
}

class _DONEsWidgetState extends State<DONEsWidget>
    with TickerProviderStateMixin {
  late DONEsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DONEsModel());
